...
function MetricCard({
  ...
  return (
    <Card className="gap-3 rounded-lg bg-muted/30 p-3 py-3 shadow-none ring-1 ring-foreground/10">
      ...
      <CardContent className="rounded-md bg-card p-3 shadow-none ring-1 ring-foreground/10">
        {isLoading ? (
        ...
        <header className="sticky top-0 z-10 flex h-[60px] shrink-0 items-center gap-2 bg-card">
          <div className="flex items-center gap-3 px-4 sm:px-6">
            ...
            <div className="flex items-center gap-2">
              <FileDown className="size-4 text-pink-500 dark:text-icon-indigo" />
              <span className="text-sm font-semibold">Insights & Exports</span>
            </div>
          </div>
        </header>
